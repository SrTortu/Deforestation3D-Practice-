...
namespace Deforestation
{
	...
	public class Rock : MonoBehaviour
	{
		...
		[Header("Configuraion")]
		[SerializeField]
		private int _maxSpawnCount = 5; // M�ximo de objetos a instanciar
		[SerializeField]
		private float _spawnRadius = 5f; // Radio de instanciaci�n
		...
		private Vector3 RandomPositionAbove()
		{
			...
			randomDirection.y = Mathf.Abs(randomDirection.y); // Asegura que la direcci�n es hacia arriba
